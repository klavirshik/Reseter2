...
![Очередь задач перезагрузки](docs/images/tasks-active.png)

### Справочник компьютеров

![Справочник компьютеров](docs/images/directory-list.png)
...
![Контроль статусов задач](docs/images/tasks-errors.png)
